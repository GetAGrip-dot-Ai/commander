...
int main(int argc, char** argv)
{
  ...
  // home_pose.orientation.x = 0.785731;
  // home_pose.orientation.y = -0.601653;
  // home_pose.orientation.z = 0.0861759;
  // home_pose.orientation.w = -0.114953;
  ...
  // // moveToPose(target_pose1); // reset to home
  ...
  // // moveToPoseWithObstacle(target_pose);
  // moveToPreGraspPose(target_pose);
  // followCartesianPath();
}
